...
- **Dependencies**: Refreshed the bundled ngrok binary to the latest stable release.

## [2.4.0] - 2026-01-20

### Added
- **Mobile Support**: New adaptive layout with responsive behavior for smaller screens.
- **Mobile Improvements**: Added dedicated stop tunnel and history buttons for mobile view.

### Changed
- **UI**: Refined request row layout for better touch accessibility and responsiveness.
- **UI**: Improved action buttons layout in request details.

## [2.3.2] - 2026-01-12

### Changed
- **Metadata**: Improved AppStream metadata with branding colors and simplified summary.
- **Documentation**: Simplified README, added Flathub/Ko-fi badges, and renamed installation section.
...
- **Mock Responses**: Intercept incoming requests and return custom status codes, bodies, and headers.
- **Import**: Support for importing requests from JSON and HAR files.
- **Editor**: Advanced GtkSourceView editor for mock responses with JSON syntax highlighting, line numbers, and "Solarized Light" theme.
- **Security**: Smart handling of ngrok auth tokens (strips `ngrok config add-authtoken` command on paste).

### Changed
- **UI**: Refined Mock Response dialog with rounded corners and card-style editor.
- **Shortcuts**: Added `Ctrl+M` shortcut for opening the Mock Response dialog.

## [2.2.2] - 2025-12-12

### Fixed
- Fixed 500 Internal Server Error when accessing the root URL
- Improved landing page layout with centered logo and better spacing
- Refined webhook inspector terminology in documentation
...
[2.4.0]: https://github.com/tobagin/sonar/compare/v2.3.2...v2.4.0
[2.3.2]: https://github.com/tobagin/sonar/compare/v2.3.1...v2.3.2
[2.3.1]: https://github.com/tobagin/sonar/compare/v2.3.0...v2.3.1
[2.3.0]: https://github.com/tobagin/sonar/compare/v2.2.2...v2.3.0
[2.2.2]: https://github.com/tobagin/sonar/compare/v2.2.1...v2.2.2
